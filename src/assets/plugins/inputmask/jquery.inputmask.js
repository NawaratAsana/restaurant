    ...
    return modules = [ function(module) {
        ...
        function determineTestTemplate(pos, tests) {
            ...
            for (var altTest = getTest.call(this, pos), targetLocator = getLocator(altTest), tstLocator, closest, bestMatch, ndx = 0; ndx < tests.length; ndx++) {
                ...
                var assets/distance = Math.abs(tstLocator - targetLocator);
                (void 0 === closest || "" !== tstLocator && assets/distance < closest || bestMatch && !opts.greedy && bestMatch.match.optionality && "master" === bestMatch.match.newBlockMarker && (!tst.match.optionality || !tst.match.newBlockMarker) || bestMatch && bestMatch.match.optionalQuantifier && !tst.match.optionalQuantifier) && (closest = assets/distance, 
                bestMatch = tst);
            }
            return bestMatch;
        }
